...
package com.viaversion.setsunavia.features.hud;

import com.viaversion.setsunavia.DioxideLiteViaImpl;
import com.viaversion.setsunavia.injection.access.core.bedrock.IChunkTracker;
import com.viaversion.setsunavia.injection.access.core.bedrock.IRakSessionCodec;
...
public final class DioxideLiteViaDebugHudEntry implements DebugScreenEntry {
    ...
    public static final Identifier ID = Identifier.fromNamespaceAndPath("setsunavia", "setsunavia");
