...
package com.viaversion.setsunavia.util.network;
...
public final class ConnectionUtil {
    ...
    public static void connectNetherNet(final NetherNetAddress address) {
        final ServerAddress serverAddress = ServerAddress.parseString(address.getNetworkId() + ".nethernet.setsunavia.localhost");
