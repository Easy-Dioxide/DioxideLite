...
package com.viaversion.setsunavia.protocoltranslator;
...
import com.viaversion.setsunavia.injection.access.core.IConnection;
import com.viaversion.setsunavia.protocoltranslator.impl.command.DioxideLiteViaCommandHandler;
import com.viaversion.setsunavia.protocoltranslator.impl.platform.DioxideLiteViaViaLegacyPlatform;
import com.viaversion.setsunavia.protocoltranslator.impl.platform.DioxideLiteViaViaVersionPlatform;
import com.viaversion.setsunavia.protocoltranslator.impl.viaversion.DioxideLiteViaPlatformLoader;
import com.viaversion.setsunavia.protocoltranslator.netty.NoReadFlowControlHandler;
import com.viaversion.setsunavia.protocoltranslator.netty.DioxideLiteViaDecoder;
import com.viaversion.setsunavia.protocoltranslator.protocol.DioxideLiteViaProtocol;
import com.viaversion.setsunavia.protocoltranslator.util.NoPacketSendChannel;
...
public final class ProtocolTranslator {
     ...
     */
    public static final AttributeKey<Connection> CLIENT_CONNECTION_ATTRIBUTE_KEY = AttributeKey.newInstance("setsunavia-clientconnection");

    /**
     * Stores the target version ViaVersion is translating to. This will be always set, even if the {@link #NATIVE_VERSION} is set.
     */
    public static final AttributeKey<ProtocolVersion> TARGET_VERSION_ATTRIBUTE_KEY = AttributeKey.newInstance("setsunavia-targetversion");
    ...
    public static CompletableFuture<Void> init(final Path path) {
        ...
        // Register command callback for /setsunavia
        ClientCommandRegistrationCallback.EVENT.register((dispatcher, registryAccess) -> {
            ...
            dispatcher.register(LiteralArgumentBuilder.<FabricClientCommandSource>literal("setsunavia").then(executor).executes(commandHandler::execute));
        });
