...
package com.viaversion.dioxidelitevia.api.settings;
...
public abstract class AbstractSetting<T> {
     ...
     * @return The name of the translation. (E. g: "dioxidelitevia.settings.base" -> "base")
     */
    public static String mapTranslationKey(final String input) {
        return input.split("dioxidelitevia.")[1];
    }
    ...
    public void lockValue() {
        this.locked = true;
        setTooltip(Component.translatable("base.dioxidelitevia.this_will_require_a_restart"));
    }
