...
package com.viaversion.dioxidelitevia.api.settings.type;
...
public class VersionedBooleanSetting extends AbstractSetting<Integer> {
    ...
    public boolean isEnabled() {
        return isEnabled(DioxideLiteVia.getImpl().getTargetVersion());
    }
    ...
    public boolean isEnabled(final Integer value) {
        return isEnabled(value, DioxideLiteVia.getImpl().getTargetVersion());
    }
