...
public abstract class MixinAbstractContainerMenu implements IAbstractContainerMenu {
    ...
    @Unique
    private short DioxideLiteVia$actionId = 0;
    ...
    @Override
    public short DioxideLiteVia$getActionId() {
        return DioxideLiteVia$actionId;
    }

    @Override
    public short DioxideLiteVia$incrementAndGetActionId() {
        return ++DioxideLiteVia$actionId;
    }
