...
package com.viaversion.dioxidelitevia.injection.mixin.features.bedrock.reach_around_raycast;
...
public abstract class MixinMinecraft {
    ...
    private HitResult bedrockReachAroundRaycast(HitResult hitResult) {
        if (ProtocolTranslator.getTargetVersion().equals(BedrockProtocolVersion.bedrockLatest)) {
            ...
            if (!this.DioxideLiteVia$canReachAround(entity)) return hitResult;
    ...
    @Unique
    private boolean DioxideLiteVia$canReachAround(final Entity entity) {
