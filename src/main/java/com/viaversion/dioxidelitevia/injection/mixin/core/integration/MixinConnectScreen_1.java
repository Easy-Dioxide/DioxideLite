...
package com.viaversion.dioxidelitevia.injection.mixin.core.integration;
...
import com.viaversion.dioxidelitevia.protocoltranslator.util.ProtocolVersionDetector;
    ...
    private Object setServerInfoAndProtocolVersion(Optional<InetSocketAddress> instance, Operation<Object> original) throws Exception {
        ...
        if (targetVersion == ProtocolTranslator.AUTO_DETECT_PROTOCOL) {
            ...
            if (!serverPinged || !targetVersion.isKnown()) {
                this.this$0.updateStatus(Component.translatable("base.dioxidelitevia.detecting_server_version"));
                try {
