...
package com.viaversion.dioxidelitevia.injection;

import com.viaversion.dioxidelitevia.features.movement.constants.LithiumWorkaround;
import com.viaversion.dioxidelitevia.features.movement.elytra.FabricAPIWorkaround;
...
public final class DioxideLiteViaMixinPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        ...
        return switch (simpleName) {
            case "C1" -> IPNEXT_PRESENT;
            case "C2" -> LITHIUM_PRESENT && !MOONRISE_PRESENT;
            case "C3" -> !LEGENDARYTOOLTIPS_PRESENT;
            case "C4" -> !LEGACY_PRESENT;
            default -> true;
        };
    }
