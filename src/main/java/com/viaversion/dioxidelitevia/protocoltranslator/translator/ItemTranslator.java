...
package com.viaversion.dioxidelitevia.protocoltranslator.translator;
...
public final class ItemTranslator {
    ...
    public static Item mcToVia(final ItemStack stack, final ProtocolVersion targetVersion) {
        ...
        try {
            ...
            final PacketWrapper setCreativeModeSlot = PacketWrapper.create(DioxideLiteViaProtocol.INSTANCE.getSetCreativeModeSlot(), buf, connection);
            ...
            return setCreativeModeSlot.read(DioxideLiteViaProtocol.INSTANCE.getServerboundItemType(targetVersion)); // item
        } catch (Throwable t) {
            DioxideLiteViaImpl.INSTANCE.getLogger().error("Error converting native item stack to ViaVersion {} item stack", targetVersion, t);
            return null;
        }
    }
    ...
    public static ItemStack viaToMc(final Item item, final ProtocolVersion sourceVersion) {
        ...
        try {
            ...
            containerSetSlot.write(DioxideLiteViaProtocol.INSTANCE.getClientboundItemType(sourceVersion), item != null ? item.copy() : null); // item
            ...
            DioxideLiteViaImpl.INSTANCE.getLogger().error("Error converting ViaVersion {} item to native item stack", sourceVersion, t);
