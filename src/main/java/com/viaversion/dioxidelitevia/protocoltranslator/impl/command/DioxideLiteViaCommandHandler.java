...
package com.viaversion.dioxidelitevia.protocoltranslator.impl.command;

import com.mojang.brigadier.arguments.StringArgumentType;
import com.mojang.brigadier.context.CommandContext;
import com.mojang.brigadier.suggestion.Suggestions;
import com.mojang.brigadier.suggestion.SuggestionsBuilder;
import com.viaversion.dioxidelitevia.protocoltranslator.impl.command.classic.ListExtensionsCommand;
import com.viaversion.dioxidelitevia.protocoltranslator.impl.command.classic.SetTimeCommand;
import java.util.concurrent.CompletableFuture;
import com.viaversion.viaversion.commands.ViaCommandHandler;
import net.fabricmc.fabric.api.client.command.v2.FabricClientCommandSource;

public final class DioxideLiteViaCommandHandler extends ViaCommandHandler {

    public DioxideLiteViaCommandHandler() {
        super(false);
    ...
    public int execute(final CommandContext<FabricClientCommandSource> ctx) {
        ...
        onCommand(new DioxideLiteViaCommandSender(ctx.getSource()), args);
        return 1;
    }
    ...
    public CompletableFuture<Suggestions> suggestion(CommandContext<FabricClientCommandSource> ctx, SuggestionsBuilder builder) {
        ...
        onTabComplete(new DioxideLiteViaCommandSender(ctx.getSource()), args).stream().map(it -> {
