...
public final class BetaCraftScreen extends DioxideLiteViaScreen {
    ...
    public static class ServerSlot extends DioxideLiteViaListEntry {
        ...
        public void mappedRender(GuiGraphicsExtractor context, int x, int y, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            if (server.onlineMode()) {
                context.text(textRenderer, Component.translatable("base.dioxidelitevia.online_mode").withStyle(ChatFormatting.GREEN), 1, 1, -1);
            }
