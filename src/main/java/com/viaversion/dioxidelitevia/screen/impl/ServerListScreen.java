...
import com.viaversion.dioxidelitevia.screen.impl.classic4j.BetaCraftScreen;
import com.viaversion.dioxidelitevia.screen.impl.classic4j.ClassiCubeLoginScreen;
import com.viaversion.dioxidelitevia.screen.impl.classic4j.ClassiCubeServerListScreen;
import com.viaversion.dioxidelitevia.screen.impl.realms.BedrockRealmsScreen;
import net.minecraft.client.gui.components.Tooltip;
import net.minecraft.client.gui.components.Button;
import net.minecraft.network.chat.Component;

public final class ServerListScreen extends DioxideLiteViaScreen {

    public static final ServerListScreen INSTANCE = new ServerListScreen();

    public ServerListScreen() {
        super(Component.translatable("screen.dioxidelitevia.server_list"), true);
    }
    ...
    protected void init() {
        ...
        if (!loggedIn) {
            classiCubeBuilder.tooltip(Tooltip.create(Component.translatable("classicube.dioxidelitevia.warning")));
        }
        ...
        if (BetaCraftScreen.SERVER_LIST == null) {
            betaCraftBuilder.tooltip(Tooltip.create(Component.translatable("betacraft.dioxidelitevia.warning")));
        }
        ...
        if (missingAccount) {
            bedrockRealmsBuilder.tooltip(Tooltip.create(Component.translatable("bedrock_realms.dioxidelitevia.warning")));
        }
