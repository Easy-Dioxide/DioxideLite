...
package com.viaversion.dioxidelitevia.screen.impl.settings;
...
public final class VersionedBooleanListEntry extends DioxideLiteViaListEntry {
    ...
    public void mappedRender(GuiGraphicsExtractor context, int x, int y, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
        ...
        final Component text = Component.translatable("base.dioxidelitevia." + (isAuto ? "auto" : isEnabled ? "on" : "off"));
