...
import com.viaversion.dioxidelitevia.screen.impl.PerServerVersionScreen;
 ...
 */
public class DioxideLiteViaList extends ObjectSelectionList<DioxideLiteViaListEntry> {

    public DioxideLiteViaList(Minecraft minecraftClient, int width, int height, int top, int bottom, int entryHeight) {
    ...
    @Override
    protected void extractSelection(final GuiGraphicsExtractor graphics, final DioxideLiteViaListEntry entry, final int outlineColor) {
