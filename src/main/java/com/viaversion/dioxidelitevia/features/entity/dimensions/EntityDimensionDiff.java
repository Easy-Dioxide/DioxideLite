...
package com.viaversion.dioxidelitevia.features.entity.dimensions;
...
public final class EntityDimensionDiff {
    ...
    public static void init() {
        final JsonObject dimensionDiff = DioxideLiteViaMappingDataLoader.INSTANCE.loadData("entity-dimensions.json");
        ...
        DioxideLiteViaImpl.CHANGE_PROTOCOL_VERSION.register((oldVersion, newVersion) -> Minecraft.getInstance().execute(() -> ENTITY_DIMENSIONS.forEach((entityType, dimensionMap) -> {
