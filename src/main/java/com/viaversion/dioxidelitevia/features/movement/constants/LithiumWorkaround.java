...
package com.viaversion.dioxidelitevia.features.movement.constants;
...
public final class LithiumWorkaround {
    ...
    public static void init() {
        // Workaround for https://github.com/ViaVersion/DioxideLiteVia/issues/1206 where lithium replaces sin/cos lookups using an optimized version
