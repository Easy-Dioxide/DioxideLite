...
package com.viaversion.dioxidelitevia.features.networking.resource_pack_header;
...
public final class ResourcePackHeaderDiff {
    ...
    public static void init() {
        final JsonObject diff = DioxideLiteViaMappingDataLoader.INSTANCE.loadData("resource-pack-headers.json");
