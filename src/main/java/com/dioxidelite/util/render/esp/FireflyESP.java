...
public final class FireflyESP {
    ...
    private static final Identifier FIREFLY_TEX = Identifier.fromNamespaceAndPath("dioxide-lite", "textures/particles/firefly.png");
    ...
    private static final RenderPipeline TARGET_ICON_NO_DEPTH_PIPELINE = RenderPipeline.builder(RenderPipelines.GUI_TEXTURED_SNIPPET)
            .withLocation(Identifier.fromNamespaceAndPath("dioxide-lite", "pipeline/DioxideLite_firefly_nodepth"))
    ...
    private static final RenderPipeline TARGET_ICON_PIPELINE = RenderPipeline.builder(RenderPipelines.GUI_TEXTURED_SNIPPET)
            .withLocation(Identifier.fromNamespaceAndPath("dioxide-lite", "pipeline/DioxideLite_firefly"))
            .withColorTargetState(new ColorTargetState(BlendFunction.LIGHTNING))
    ...
    private static final Function<RenderPipeline, RenderType> TARGET_ICON_LAYER = Util.memoize(
            renderPipeline -> RenderType.create("DioxideLite_firefly", RenderSetup.builder(renderPipeline)
