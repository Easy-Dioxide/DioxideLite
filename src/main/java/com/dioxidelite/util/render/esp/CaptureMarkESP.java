...
public final class CaptureMarkESP {
    ...
    private static final Identifier CAPTUREMARK_TEX = Identifier.fromNamespaceAndPath("dioxidelite", "textures/particles/target.png");

    private static final RenderPipeline TARGET_ICON_PIPELINE = RenderPipeline.builder(RenderPipelines.GUI_TEXTURED_SNIPPET)
            .withLocation(Identifier.fromNamespaceAndPath("dioxidelite", "pipeline/dioxidelite_target_icon"))
