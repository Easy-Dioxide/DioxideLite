...
public final class CaptureMarkESP {
    ...
    private static final Identifier CAPTUREMARK_TEX = Identifier.fromNamespaceAndPath("dioxide-lite", "textures/particles/target.png");

    private static final RenderPipeline TARGET_ICON_PIPELINE = RenderPipeline.builder(RenderPipelines.GUI_TEXTURED_SNIPPET)
            .withLocation(Identifier.fromNamespaceAndPath("dioxide-lite", "pipeline/DioxideLite_target_icon"))
            .withColorTargetState(new ColorTargetState(BlendFunction.TRANSLUCENT))
            .withDepthStencilState(new DepthStencilState(CompareOp.ALWAYS_PASS, false))
            .withCull(false)
            .build();

    private static final RenderType TARGET_ICON_LAYER = RenderType.create("DioxideLite_target_icon", RenderSetup.builder(TARGET_ICON_PIPELINE)
