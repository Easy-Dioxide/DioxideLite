...
public final class FrameBlendingManager {
    ...
    private static final Identifier FRAME_BLENDING_ID = Identifier.fromNamespaceAndPath("dioxide_lite", "frame_blending");
    private static final Identifier ACCUMULATION_MAX_ID = Identifier.fromNamespaceAndPath("dioxide_lite", "accumulation_max");
    private static final Identifier ACCUMULATION_MIX_ID = Identifier.fromNamespaceAndPath("dioxide_lite", "accumulation_mix");
