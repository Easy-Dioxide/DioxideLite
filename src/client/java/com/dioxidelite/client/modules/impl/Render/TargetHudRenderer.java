...
public class TargetHudRenderer {
    ...
    private static final Identifier TEXTURE_ID = Identifier.fromNamespaceAndPath("dioxide_lite", "target_hud_new");
    private static final Identifier OVERLAY_TEXTURE_ID = Identifier.fromNamespaceAndPath("dioxide_lite", "target_hud_new_overlay");
    private static final Identifier AVATAR_MASK_TEXTURE_ID = Identifier.fromNamespaceAndPath("dioxide_lite", "target_hud_avatar_mask");
    private static final Identifier AVATAR_FLASH_TEXTURE_ID = Identifier.fromNamespaceAndPath("dioxide_lite", "target_hud_avatar_flash");
    private static final Identifier ROUNDED_AVATAR_TEXTURE_ID = Identifier.fromNamespaceAndPath("dioxide_lite", "target_hud_rounded_avatar");
    ...
    private boolean renderRoundedPlayerAvatarTexture(GuiGraphics graphics, Minecraft client, PlayerSkin skin, int x, int y, int size) {
        ...
        if (pendingRoundedAvatarImage != null && key.equals(pendingRoundedAvatarKey) && pendingRoundedAvatarImage.isDone()) {
            try {
                ...
                roundedAvatarTexture = new DynamicTexture(() -> "dioxide_lite:target_hud_rounded_avatar", image);
    ...
    private void renderNewBaseTexture(Minecraft client, String name, boolean blurMode) {
        ...
        if (surface == null || dynamicTexture == null || targetW != textureW || targetH != textureH) {
            ...
            dynamicTexture = new DynamicTexture("dioxide_lite:target_hud_new", targetW, targetH, false);
    ...
    private void renderNewOverlayTexture(Minecraft client, String healthText, float healthRatio, float absorptionRatio, long now, boolean blurMode) {
        ...
        if (overlaySurface == null || overlayTexture == null || targetW != overlayTextureW || targetH != overlayTextureH) {
            ...
            overlayTexture = new DynamicTexture("dioxide_lite:target_hud_new_overlay", targetW, targetH, false);
    ...
    private void renderAvatarMaskTexture(Minecraft client) {
        ...
        avatarMaskTexture = new DynamicTexture("dioxide_lite:target_hud_avatar_mask", targetW, targetH, false);
    ...
    private void renderAvatarFlashTexture(Minecraft client, float alpha, float hurtFlashFactor, float healFlashFactor) {
        ...
        avatarFlashTexture = new DynamicTexture("dioxide_lite:target_hud_avatar_flash", targetW, targetH, false);
