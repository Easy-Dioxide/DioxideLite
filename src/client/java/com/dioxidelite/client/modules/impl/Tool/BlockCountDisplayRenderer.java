...
public class BlockCountDisplayRenderer {
    ...
    private static final Identifier TEXTURE_ID = Identifier.fromNamespaceAndPath("dioxide_lite", "block_count_display");
    private static final Identifier OVERLAY_TEXTURE_ID = Identifier.fromNamespaceAndPath("dioxide_lite", "block_count_display_overlay");
    ...
    private void renderBaseTexture(Minecraft client, String name, boolean blurMode) {
        ...
        if (surface == null || dynamicTexture == null || targetW != textureW || targetH != textureH) {
            ...
            dynamicTexture = new DynamicTexture("dioxide_lite:block_count_display", targetW, targetH, false);
    ...
    private void renderOverlayTexture(Minecraft client, String speed, float progress, boolean blurMode) {
        ...
        if (overlaySurface == null || overlayTexture == null || targetW != overlayTextureW || targetH != overlayTextureH) {
            ...
            overlayTexture = new DynamicTexture("dioxide_lite:block_count_display_overlay", targetW, targetH, false);
