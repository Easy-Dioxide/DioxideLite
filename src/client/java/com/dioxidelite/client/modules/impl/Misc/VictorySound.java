package com.dioxidelite.client.modules.impl.Misc;
...
public class VictorySound {
    private static final Path EXTERNAL_PATH = FabricLoader.getInstance().getGameDir().resolve("DioxideLite/sounds");
