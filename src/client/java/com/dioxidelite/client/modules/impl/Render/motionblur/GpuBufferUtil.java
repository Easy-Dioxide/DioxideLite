...
public final class GpuBufferUtil {
    ...
    public static GpuBuffer createUBO(String debugName, int sizeBytes) {
        ...
        Supplier<String> label = () -> "dioxide_lite:" + debugName;
        try {
            ...
            throw new RuntimeException("[DioxideLite] No compatible createBuffer found on " + device.getClass(), e);
        } catch (ReflectiveOperationException e) {
            throw new RuntimeException("[DioxideLite] GpuBufferUtil.createUBO failed", e);
        }
    }
