...
import static com.viaversion.setsunavia.screen.DioxideLiteViaListEntry.SLOT_MARGIN;
...
public final class ClassiCubeServerListScreen extends DioxideLiteViaScreen {
    ...
    protected void init() {
        ...
        if (SERVER_LIST == null) {
            ...
            setupSubtitle(Component.translatable("betacraft.setsunavia.loading"));
            return;
        }
        ...
        this.addRenderableWidget(Button.builder(Component.translatable("base.setsunavia.logout"), button -> {
    ...
    public void extractRenderState(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final float a) {
        ...
        final CCAccount account = SaveManager.INSTANCE.getAccountsSave().getClassicubeAccount();
        graphics.text(font, Component.translatable("classicube.setsunavia.profile"), 32, 6, -1);
