...
import com.viaversion.setsunavia.features.networking.legacy_chat_signature.KeyPairResponse1_19_0;
...
public abstract class MixinYggdrasilUserApiService {
    ...
    public KeyPairResponse getKeyPair() {
        ...
        if (response.publicKeySignature() != null && response.publicKeySignature().array().length != 0) {
            ((IProfilePublicKey_Data) (Object) keyPairResponse).setsunavia$setLegacyPublicKeySignature(response.publicKeySignature().array());
        } else {
