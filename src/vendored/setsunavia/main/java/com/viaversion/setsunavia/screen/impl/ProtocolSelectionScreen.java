...
public final class ProtocolSelectionScreen extends DioxideLiteViaScreen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(Component.translatable("base.setsunavia.settings"), button -> SettingsScreen.INSTANCE.open(this)).pos(width - 98 - 5, 5).size(98, 20).build());
        ...
        this.addRenderableWidget(Button.builder(Component.translatable("report.setsunavia.button"), button -> ReportIssuesScreen.INSTANCE.open(this))
