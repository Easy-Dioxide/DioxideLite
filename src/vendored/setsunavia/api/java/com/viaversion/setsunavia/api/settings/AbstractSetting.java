...
package com.viaversion.setsunavia.api.settings;
...
public abstract class AbstractSetting<T> {
     ...
     * @return The name of the translation. (E. g: "setsunavia.settings.base" -> "base")
     */
    public static String mapTranslationKey(final String input) {
        return input.split("setsunavia.")[1];
    }
    ...
    public void lockValue() {
        this.locked = true;
        setTooltip(Component.translatable("base.setsunavia.this_will_require_a_restart"));
    }
